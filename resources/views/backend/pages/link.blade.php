                    ...
                    <table class="table align-items-center table-flush table-hover">
                        ...
                        <tr>
                            <th scope="col">Facebook</th>
                                <td class="multiline_td">{{$link->facebook}}</td>
                        </tr>
                        <tr>
                            <th scope="col">Instagram</th>
                                <td class="multiline_td">{{$link->instagram}}</td>
                        </tr>
                        <tr>
                            <th scope="col">LinkedIn</th>
                                <td class="multiline_td">{{$link->linkedin}}</td>
                        </tr>
                        <tr>
                            <th scope="col">GitHub</th>
                                <td class="multiline_td">{{$link->github}}</td>
                        </tr>
                        <tr>
